                ...
                <table class="board_write">
                    ...
                    <tbody>
                        <tr>
                            <th>*이메일</th>
                            <td>
                                <input type="text" name="email" id="email" class="inNextBtn" style="float:left;" placeholder="이메일">
                        ...
                        <tr>
                            ...
                            <td><input type="password" name="pwd_check" id="pwd_check" style="float:left;" placeholder="password"></td>
                        </tr>
                        <tr>
                            <th>*이름</th>
                        ...
                        <tr>
                            <th>*생년월일</th>
                            <!-- name 과 id 값이 같으면 데이터의 값이 기본값으로 ('')이들어간다. name 과 id의 값이 다르면 null이 기본값으로 들어감 -->
